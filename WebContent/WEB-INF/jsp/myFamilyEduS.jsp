	...
	<div class='p_main'>
		<div class='p_wrapper'>
			<div class='p_menu'>
				...
				<div class='p_block'>
					<ul class='nav'>
						<li><a class='p_active' href='${pageContext.request.contextPath}/user/myFamilyEduS'>
					...
					<div class='p_block'>
						<div class='col-md-12 col-xs-12 margin-task'>
							...
							<div class='col-md-12 col-xs-12 task-wrap-padding'>
								...
								<div class='col-md-12 col-xs-12'>
									<a class='task-style' href='${pageContext.request.contextPath}/user/myFamilyEduS/base'>
								...
								<div class='col-md-12 col-xs-12'>
									<a class='task-style'
										href='${pageContext.request.contextPath}/user/myFamilyEduS/student'>
										<div class='col-md-1 col-xs-1'>
											<P>
											<h1>
												<i class='glyphicon glyphicon-hand-right'></i>
								...
								<div class='col-md-12 col-xs-12'>
									<a class='task-style' href='${pageContext.request.contextPath}/'>
										<div class='col-md-1 col-xs-1'>
											<P>
											<h1>
												<i class='glyphicon glyphicon-hand-right'></i>
