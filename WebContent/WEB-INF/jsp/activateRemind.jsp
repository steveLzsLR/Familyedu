...
<body>
	<div class='bigbar-header autowidth'>
		<div class='bigbar-wrapper'>
			...
			<h2>
				你好，欢迎来到家教网！ <a href="${pageContext.request.contextPath}/user/login">请登录</a>
			</h2>
		</div>
	</div>
	...
	<div class='preg_cta2'>
		<div class="data_list user">
			...
			<c:choose>
				<c:when test="${param.errorCode==301}">
				 <div class="margin_top10">
				注册失败!请检查您的邮箱地址是否正确!&nbsp;<span id="downNum" style="font-weight: bold;">5</span>&nbsp;秒后页面自动跳转到启学家教网注册页，点击<a href="${pageContext.request.contextPath}/user/register">立即跳转</a>
				</div>
				</c:when>
				<c:otherwise>
				  <div class="margin_top10">
				    注册成功!请到注册邮箱激活帐户!&nbsp;<span id="downNum" style="font-weight: bold;">5</span>&nbsp;秒后页面自动跳转到启学家教网首页，点击<a href="${pageContext.request.contextPath}/">立即跳转</a>
				</div>
				</c:otherwise>
			</c:choose>
			<br clear="all" />
