			...
			<div class='p_menu'>
				...
				<div class='p_block'>
					<ul class='nav'>
						...
						</a> <a class='p_active' href='${pageContext.request.contextPath}/user/myFamilyEduT/order/confirmed?page=1'> <i
						...
						<c:forEach items="${tMyOrders }" var="myOrder">
							<tr>
								...
								<c:if test="${myOrder.status==0}">
									<td style="text-align: center; vertical-align: middle;"
										colspan="1">
										<form action="${pageContext.request.contextPath}/user/myFamilyEduT/order/deleteOrder"
											method="post">
									...
									<td style="text-align: center; vertical-align: middle;"
										colspan="1">
									<form action="${pageContext.request.contextPath}/user/myFamilyEduS/order/deleteOrder"
											method="post">
											<input type="hidden" name="location"
												value="redirect:/user/myFamilyEduT/order/confirmed?page=1">
											<input type="hidden" name="orderId" value="${myOrder.id}">
				...
				<div
					...
					<ul class="pagination">
						<c:if test="${sessionScope.tOrdersCurrentPage!=1}">
							<li><a
								href="${pageContext.request.contextPath}/user/myFamilyEduT/order/confirmed?page=${sessionScope.tOrdersCurrentPage}&pageAction=pre"
						...
						<c:forEach begin="${sessionScope.tOrdersBeginPage}"
							...
							<c:if test="${ v==tOrdersCurrentPage}">
								<li class="active"><a
									href="${pageContext.request.contextPath}/user/myFamilyEduT/order/confirmed?page=${v }">${v}</a></li>
							</c:if>
							<c:if test="${ v!=tOrdersCurrentPage}">
								<li><a href="${pageContext.request.contextPath}/user/myFamilyEduT/order/confirmed?page=${v }">${v}</a></li>
							</c:if>
						</c:forEach>
						<c:if
							...
							<li><a
								href="${pageContext.request.contextPath}/user/myFamilyEduT/order/confirmed?page=${sessionScope.tOrdersCurrentPage}&pageAction=next"
