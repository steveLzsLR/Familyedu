			...
			<div class='p_menu'>
				...
				<div class='p_block'>
					<ul class='nav'>
						...
						<li><a class='p_active'
							href='${pageContext.request.contextPath}/user/myFamilyEduS/userPassword'> <i
				...
				<div class='p_block'>
					<div class='p_block_password'>
						<form accept-charset="UTF-8"
							action="${pageContext.request.contextPath}/user/myFamilyEduS/userPassword/updatePassword"
