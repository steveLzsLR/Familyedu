...
<body>
	...
	<div class='preg_cta2'>
		<div class="data_list user">
			...
			账户激活失败!请检查激活网址是否正确！&nbsp;<span id="downNum" style="font-weight: bold;">10</span>&nbsp;秒后页面自动跳转到启学家教网首页，点击<a href="/FamilyEdu">立即跳转</a>
			</div>
			<br clear="all" />
		</div>
	</div>
